...
#define START_MASTERNODE_PAYMENTS_TESTNET 1512691200
#define START_MASTERNODE_PAYMENTS 1512691200 // Friday, December 8, 2017 12:00:00 AM

static const int64_t DARKSEND_COLLATERAL = (2500*COIN); //2500
...
static const int PREMINE_BLOCK = 1;
